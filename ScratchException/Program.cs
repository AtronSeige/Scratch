...
namespace ScratchException
{
	class Program
	{
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine("All done. Click any key to close the app.");
            Console.ReadLine();
        }
        ...
        private static string ProcessException(Exception ex)
        {
            ...
            {
                string errstr = String.Format("Exception Occured in ProcessException(Exception ex) during the writing of an exception\n\n\n{0}\n\n\nOriginal Exception\n\n\n{1}n\n\nInfo Before Inner Exception\n\n\n{2}",
                innerEx.ToString(),
